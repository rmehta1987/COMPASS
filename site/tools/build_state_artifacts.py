...
def main() -> int:
    ...
    write("score.json", {
        ...
        "scored_run_note": "the stamp above is the generation clone at capture; the scored run's own tree and run id are in its own artifact and in REPRODUCIBILITY.md, not on this page, which prints no run stamps",
