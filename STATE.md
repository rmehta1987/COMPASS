...
- [ ] B4 posed-pair driver (pipeline/pose.py from 16a) + a synthetic inventory of 3-4 papers with real dictionary keys used by the tests; the run's artefacts state the inventory was synthetic
