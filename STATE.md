...
build: 3dc8415eccfe
last green: 3858aa5   (VERIFIED 2026-09-04 by ./check.sh, GREEN)
...
- [~] B1 accept half: re-run b4-20260904 (same 48 pairs, seed 0, new prompt) launched 22:50, ~7 h; the after rate is reported when it ends; b4's artefacts stay UNTRACKED (not a baseline; the operator may stamp/tag it if wanted)
