...
build: 3dc8415eccfe
last green: 2965e85   (VERIFIED 2026-09-04 by ./check.sh, GREEN)
...
- [ ] B5 benchmark/specification_score.py, harness mode 2: same refusals/verdicts/loading; covariate recall/precision + modal baseline + margin, design agreement with base rate (or omitted per B3a), direction agreement with base rate, excluded rows, in_instrument=False papers counted apart, discovery rate beside never pooled, verdicts, ceiling, n on every figure
