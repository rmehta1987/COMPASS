...
(https://github.com/rmehta1987/COMPASS). The rule holds at the tip of `main` since the
2026-09-04 merge; before it, `main` (at 6416094) tracked `deploy/targets.json` and three
per-row artifacts, and those remain in history (§What is withheld). Only a history rewrite
or making the repository private fixes the past.
...
re-run against the current manifest is pending. The Wright run is recorded in commits
[da317d6](https://github.com/rmehta1987/COMPASS/commit/da317d602738ca6752d9f8264accdd4a2ffac64e) and
